...
This page is the fastest entrypoint into the repository's knowledge base when you are an AI coding agent trying to answer a question, review a change, or edit documentation about zero-knowledge systems.

## How to Work Efficiently

1. Start with the smallest document that matches the task.
2. Use the glossary when a term is unfamiliar rather than scanning the whole manuscript.
3. Follow each document's **Related Topics** links to expand only when the task requires more context.
4. Use the bibliography when you need to trace a claim back to cited literature.

## Task-to-Document Lookup

### I need a fast orientation to the repository's subject matter
...
### I need terminology or concept definitions
- [Glossary](glossary.md)
...
### I need compiler, language, or circuit-safety context
...
### I need proof-system or arithmetization context
...
### I need privacy-system comparisons
...
- [The full manuscript](../the-seven-layer-magic-trick.md)

## Recommended Minimal Reading Paths

### For code review
- [The Seven-Layer Model](01-foundations/seven-layer-model.md)
- [Glossary](glossary.md)
- One topic-specific document matching the code or docs under review

### For documentation writing
- [What Are Zero-Knowledge Proofs?](01-foundations/what-are-zk-proofs.md)
- [Glossary](glossary.md)
- The relevant layer or ecosystem document from the lookup above
